...
(function(){
  ...
  function renderMovers(m){
    ...
    h+=moverList("badges unlocked", m.unlocked, function(x){ return x.badges.map(function(b){ return '<span class="bg">'+esc(VNAMES[b.id]||b.id)+(b.tier?" "+["","i","ii","iii"][b.tier]:"")+'</span>'; }).join(", "); });
    $("mgrid").innerHTML=h;
